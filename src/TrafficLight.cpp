...
void MessageQueue<T>::send(T &&msg)
{
   ...
   // simulate some work
    ...
    _cond.notify_one(); // notify client after pushing new Vehicle into vect
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    // initalize variables
    double cycleDuration = dist6(rng); // duration of a single simulation cycle in ms
